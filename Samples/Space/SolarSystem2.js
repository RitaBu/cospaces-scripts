...
function Sun(scale) {
  ...
  this.item = Space.createItem('Sphere', this.pos.x, this.pos.y, this.pos.z);
  this.item.setScale(scale);
  this.item.setColor(252, 212, 64);
  this.corona = Space.createItem('Cloud', this.pos.x, this.pos.y, this.pos.z);
...
function Satellite(pos, id) {
  ...
  this.camera = Space.createItem('Sphere', pos.x, pos.y, pos.z + ZPOS_OFFSET);
